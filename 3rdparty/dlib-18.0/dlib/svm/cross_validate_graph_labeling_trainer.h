...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        double num_pos_i = 0.0;
        double num_neg_i = 0.0;
        double num_true_pos_i = 0.0;
        double num_retrieved = 0.0;
        ...
        if (num_neg != 0)
            ...
            res(1) = 1;
        // precision
        res(0) = num_true_pos_i / num_retrieved;
        // recall
        res(1) = num_true_pos_i / num_pos_i;
        return res;
    }
...
// ----------------------------------------------------------------------------------------
    ...
    template <
        ...
        typename graph_type
        >
    matrix<double,1,4> cross_validate_graph_labeling_trainer (
    ...
    )
    {
        ...
        if (num_neg != 0)
            ...
            res(1) = 1;
        res(2) = num_true_pos_i / num_retrieved;    // precision
        res(3) = num_true_pos_i / num_pos_i;        // recall
        return res;
    }
